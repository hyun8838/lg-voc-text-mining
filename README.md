...
* 소형 의류관리기 라인업 확장 근거: '미니' 키워드 3개년 연속 상위 등장 — 소형 모델에 대한 소비자 수요가 언어 데이터에 지속 반영, 라인업 기획 시 수요 사전 포착 가능

* 핸디형 청소기 독립 마케팅 채널 분리 근거: 무선청소기 연관 키워드에서 '핸디' 지속 등장 — 스틱형과 별개의 독립 수요 축 실증, 제품군·마케팅 자원 배분 재설정 가능

* AI 가전 광고 카피 방향 재설정: '편리하다' 연관어가 2024 기준 사용성·흡입력·성능·효율적이다로 확장 — "편리함" 인식이 조작 편의에서 성능·효율 평가로 이동, 이 흐름을 반영한 카피 수립 가능

* 브랜드별 포지셔닝 전략 수립: AI 모델 연관어(코스·케어·올뉴·구김)와 일반 모델 연관어(시트·향기·탈취) 분리 확인 — 라인별 차별화 메시지 수립, 에어드레서·비스포크 등 경쟁 브랜드 비교 맥락 대응 가능

* 동일 파이프라인 타 제품군 확장: 냉장고·TV·에어컨에 검색 키워드 재설정만으로 동일 구조 재사용 가능
